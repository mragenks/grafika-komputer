 ...
 */
public class DoubleBufferingClockExample2 extends TimerTask {
   ...
   */
  DoubleBufferingClockExample2(BufferedImageDrawer bid, BufferedImage backGround,
  ...
  public static void main(String[] argv) {
    ...
    DoubleBufferingClockExample2 dbce = new DoubleBufferingClockExample2(bid,
        backGround,
        height,
        delay);
